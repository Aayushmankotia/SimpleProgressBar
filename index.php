...
<body>
  <div class="main_container">
    <table id="numberTable">
      ...
      for ($i = 1; $i <= 7; $i++) {
        ...
        for ($j = 1; $j <= 7; $j++) {
          ...
          // count add the value on each cell of table from 1 to 49
          $count++;
        }
        echo "</tr>";
      }
    ...
    <div class="cover-container">
      <div id="container">
        ...
        for ($i = 1; $i <= 49; $i++) {
          // To set the default selected option for each question 
  ...
  <div class="bar_divmain">
    ...
    <div id="defaultprogressInfo" class="infoprogress">
      <div id="defaultScoreInfo" class="infoscore">Score 2023: 0</div>
      <div id="defaultprogressBar" class="barbar">
        <div id="defaultprogressA" class="progress progress-A">
          <div id="defaultbarOptionA"></div>
          <div id="defaultbarOptioncountA" class="barOption"></div>
        </div>
        <div id="defaultprogressB" class="progress progress-B">
          <div id="defaultbarOptionB"></div>
          <div id="defaultbarOptioncountB" class="barOption"></div>
        </div>
        <div id="defaultprogressC" class="progress progress-C">
          <div id="defaultbarOptionC"></div>
          <div id="defaultbarOptioncountC" class="barOption"></div>
        </div>
        <div id="defaultprogressD" class="progress progress-D">
          <div id="defaultbarOptionD"></div>
          <div id="defaultbarOptioncountD" class="barOption"></div>
        </div>
        <div id="defaultprogressE" class="progress progress-E">
          <div id="defaultbarOptionE"></div>
          <div id="defaultbarOptioncountE" class="barOption"></div>
        </div>
      </div>
    </div>

    <div id="progressInfo" class="infoprogress">
      <div id="scoreInfo" class="infoscore">Score 2024: 0</div>
      <div id="progressBar" class="barbar">
        <div id="progressA" class="progress progress-A">
          <div id="barOptionA"></div>
          <div id="barOptioncountA" class="barOption"></div>
        </div>
        <div id="progressB" class="progress progress-B">
          <div id="barOptionB"></div>
          <div id="barOptioncountB" class="barOption"></div>
        </div>
        <div id="progressC" class="progress progress-C">
          <div id="barOptionC"></div>
          <div id="barOptioncountC" class="barOption"></div>
        </div>
        <div id="progressD" class="progress progress-D">
          <div id="barOptionD"></div>
          <div id="barOptioncountD" class="barOption"></div>
        </div>
        <div id="progressE" class="progress progress-E">
          <div id="barOptionE"></div>
          <div id="barOptioncountE" class="barOption"></div>
        </div>
      </div>
    </div>
  ...
  <script>
    ...
    function updateProgressBar() {
      ...
      // To remove the bar color on unhighlight all cells 
      if (totalOptions === 0) {
    ...
    // To display default progress bar, depending upon highlighted cells ,checked radio option and score of each option
    function updateDefaultProgressBar() {
      ...
      // To get the total of option checked
      visibleDivs.forEach(function(div) {
        var selectedOption = div.querySelector('input[type="radio"][checked]');
        if (selectedOption) {
          var optionValue = selectedOption.value;
          defaultOptionCounts[optionValue]++; // no idea
        }
      });
